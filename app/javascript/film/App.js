    ...
    <div className="app">
      ...
      <div className="movie-controls">
        <button
          ...
          className="btn generate-btn btn-primary"
        >
          Generate movie
        </button>
        <button
        ...
        >
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g clipPath="url(#clip0_327_152)">
              <g clipPath="url(#clip1_327_152)">
                ...
                <path d="M10.0827 8.87508C11.4174 8.87508 12.4993 7.7931 12.4993 6.45841C12.4993 5.12373 11.4174 4.04175 10.0827 4.04175C8.74799 4.04175 7.66602 5.12373 7.66602 6.45841C7.66602 7.7931 8.74799 8.87508 10.0827 8.87508Z" stroke="white" strokeWidth="1.5" />
                <path d="M16.1257 14.9168C17.4603 14.9168 18.5423 13.8349 18.5423 12.5002C18.5423 11.1655 17.4603 10.0835 16.1257 10.0835C14.791 10.0835 13.709 11.1655 13.709 12.5002C13.709 13.8349 14.791 14.9168 16.1257 14.9168Z" stroke="white" strokeWidth="1.5" />
                <path d="M10.0827 20.9583C11.4174 20.9583 12.4993 19.8764 12.4993 18.5417C12.4993 17.207 11.4174 16.125 10.0827 16.125C8.74799 16.125 7.66602 17.207 7.66602 18.5417C7.66602 19.8764 8.74799 20.9583 10.0827 20.9583Z" stroke="white" strokeWidth="1.5" />
              </g>
            </g>
            <defs>
